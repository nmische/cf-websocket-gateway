 ...
 * methods within are called by <tt>WebSocket</tt>.
 * 
...
interface WebSocketListener extends WebSocketProtocol {
   ...
   * Indicates that a complete WebSocket connection has been established, and we
   * are ready to send/recieve data.
   * 
   * @param conn
   *          The <tt>WebSocket</tt> instance this event is occuring on.
   */
